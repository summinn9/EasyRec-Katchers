...
class LightGCN_plus(BaseModel):
	def __init__(self, data_handler):
		...
		# semantic-embeddings
		# self.usrprf_embeds_path = "./data/{}/usr_emb_np.pkl".format(configs['data']['name'])
		# self.itmprf_embeds_path = "./data/{}/itm_emb_np.pkl".format(configs['data']['name'])
		# with open(self.usrprf_embeds_path, 'rb') as f:
