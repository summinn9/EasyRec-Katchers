...
>There’s a minor typo in Table 10 and Appendix F.5 of the paper, the metric we calculated is “Intra-List Distance (ILD)” but not “Intra-List Similarity (ILS)”. We’ve fixed this in the arXiv version respectively.
